...
namespace JustinsHelpers.Tests
{
    ...
    public class FirstSix
    {
        ...
        [Test]
        public void ReturnsFirstSix()
        {
            var list = new List<int> { 1, 2, 3, 4, 5, 6, 7, 8, 9 };
            var (first, second, third, fourth, fifth,sixth) = list.FirstSix();
            Assert.Multiple(() =>
            {
        ...
        public void ThrowsIfOneElement()
        {
            ...
            Assert.Throws<ArgumentException>(() => list.FirstSix());
        }
        [Test]
        ...
        [Test]
        public void OrDefaultReturnsFirstSix()
        {
            var list = new List<int> { 1, 2, 3, 4, 5, 6, 7, 8, 9 };
            var (first, second, third, fourth,fifth,sixth) = list.FirstSixOrDefault();
            Assert.Multiple(() =>
            {
                Assert.AreEqual(first, 1);
                Assert.AreEqual(second, 2);
